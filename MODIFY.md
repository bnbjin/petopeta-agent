...
The Petopeta repo was built to serve two use cases.
...
One of the simplest ways to modify Petopeta and get a feel for the codebase is to modify the vector store.
All of the operations in Petopeta are largely based around the vector store:
...
Petopeta uses embeddings inside the ingestion script when storing documents in the vector store.
